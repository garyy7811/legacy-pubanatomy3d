...
public class V3dStructure{
    ...
    private V3dModelId visualModel;

    private V3dModelId sectionModel;
    ...
    public V3dModelId getVisualModel(){
        return visualModel;
    }

    public void setVisualModel( V3dModelId visualModel ){
        this.visualModel = visualModel;
    }

    public V3dModelId getSectionModel(){
        return sectionModel;
    }

    public void setSectionModel( V3dModelId sectionModel ){
    ...
    public boolean equals( Object o ){
        ...
        if( ! ( o instanceof V3dStructure ) ){
            return false;
        }

        V3dStructure that = ( V3dStructure )o;
